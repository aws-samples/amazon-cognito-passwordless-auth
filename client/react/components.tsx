...
const FlexContainer = (props: { children: React.ReactNode; brand?: CustomBrand }) => {
  return <div className="passwordless-main-container">
    { props.brand?.backgroundImageUrl && <img src={props.brand.backgroundImageUrl} className="passwordless-main-background-image" />}
    <div className="passwordless-card-container">
      { props.brand?.customerLogoUrl && <img src={props.brand.customerLogoUrl} className="passwordless-customer-logo" />}
      { props.brand?.customerName && <h3 className="passwordless-text-center passwordless-customer-name">{ props.brand.customerName }</h3> }
      { props.children }
    </div>
  </div>;
};
    ...
    return (
      <FlexContainer brand={brand}>
        <div className="passwordless-flex">
          <img src={spinner as string} className="passwordless-loading-spinner" />
    ...
    return (
      <FlexContainer brand={brand}>
        <div className="passwordless-flex passwordless-flex-align-start">
          ...
          <div>
            <div className="passwordless-text-left"><strong>Please check your email.</strong></div>
    ...
    <FlexContainer brand={brand}>
        ...
        <div>
                ...
                (userVerifyingPlatformAuthenticatorAvailable ||
                  ...
                  <div>
                    ...
                    <p className="passwordless-flex passwordless-flex-vertical-buttons">
                      ...
                      <button
                        className="passwordless-button passwordless-button-outlined passwordless-button-sign-in"
                  ...
                  <>
                    ...
                    <button
                      className="passwordless-button passwordless-plain-button passwordless-button-sign-in-magic-link"
          ...
          {showUsernameInput === false ? (
            <>
              <div></div>
              <button
                className="passwordless-button passwordless-plain-button passwordless-button-sign-in-as-other-user"
                disabled={busy}
            ...
            <>
              ...
              >
                <label className="passwordless-input-label">Enter your email to sign in</label>
                <input
                ...
                >
                  <div className="passwordless-flex">
                    ...
                    <svg
                      ...
                      width="18px"
                    >
                      <polygon id="Path" points="14.1015625 6.08091905 19.1386718 11.2357642 2 11.2357642 2 12.7642358 19.1386718 12.7642358 14.0996094 17.9190808 15.1582031 19 22 12.000999 15.1582031 5"></polygon>
                    </svg>
                  </div>
                </button>
              </form>
      ...
      <div className="passwordless-flex">
        {signingInStatus === "SIGNIN_LINK_EXPIRED" && (
          <div className="passwordless-flex passwordless-flex-align-start">
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" className="rotate-45">
            ...
            <div>
              <div className="passwordless-text-left"><strong>Authentication error.</strong></div>
