...
export const Passwordless = ({
  ...
  if (signInStatus === "SIGNED_IN") {
    ...
    if (showOptionsForUser !== "LAST_USER") {
  ...
  const user: typeof lastUser =
    newUsername && showOptionsForUser === "NEW_USER"
      ? {
          email: newUsername,
          username: newUsername,
          useFido: "YES", // presume the user might want to use FIDO2
        }
      : showOptionsForUser === "LAST_USER"
      ? lastUser
      : undefined;
      ...
      {signInStatus === "NOT_SIGNED_IN" && user && (
        <div>
          ...
          <button
            ...
            onClick={() => setShowOptionsForUser("NEW_USER_ENTRY")}
          >
      ...
      {signInStatus === "NOT_SIGNED_IN" && !user && (
        <>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              setShowOptionsForUser("NEW_USER");
              return false;
            }}
          >
